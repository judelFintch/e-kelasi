                ...
                <div id="sidebar-menu" class="sidebar-menu">
                    <ul>
                       <!--
                        ...
                        <li class="submenu">
                            <a href="#"><i class="la la-files-o"></i> <span> Versement </span> <span
                                    class="menu-arrow"></span></a>
                            <ul style="display: none;">
                        ...
                        <li class="submenu">
                            <a href="#"><i class="la la-files-o"></i> <span> Comptabilité</span> <span
                                    class="menu-arrow"></span></a>
                            <ul style="display: none;">
                        ...
                        <li class="submenu">
                            <a href="#"><i class="la la-money"></i> <span> Payroll </span> <span
                                    class="menu-arrow"></span></a>
                            <ul style="display: none;">
                                <li><a class="" href="salary"> Salaire Employés </a></li>
                                <li><a class="" href="salary_view"> Fiche de Paie </a></li>
                                <li><a class="" href="payroll_item"> Eléments de paie </a></li>
                            </ul>
                        </li>
                        ...
                        <li class="submenu">
                            <a href="#"><i class="la la-pie-chart"></i> <span> Reports </span> <span
                                    class="menu-arrow"></span></a>
                            <ul style="display: none;">
                                <li><a class="" href="expense_reports"> Rapport de dépenses </a></li>
                                <li><a class="" href="invoice_reports"> Invoice Report </a></li>
                                <li><a class="" href="payment_reports">  Rapport de versement</a></li>
                        ...
                        <li class="submenu">
                            <a href="#"><i class="la la-table"></i> <span> Configuration </span> <span
                                    class="menu-arrow"></span></a>
                            <ul style="display: none;">
                                <li><a class="" href="{{route('userroles.index')}}">Roles </a></li>
